# aurelia-skeleton-navigation-typescript-webpack2
...
To build an optimized, minified, tree-shaken production bundle (output to /dist) execute:
...
> **Note**: The tests aren't working yet
